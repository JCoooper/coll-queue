	...
	public static void main(String[] args) {
		...
		while (line.size() > 0) {
			...
			if (line.element().getWait() == 0) {
				System.out.println("");
				System.out.println("Item '" + line.element().getItem() + "' made!!");
				System.out.println("");
				line.remove();
				wait = 5;
			} else {
				// line.element().getWait()
				System.out.println("");
				System.out.println("Item not done, please wait: " + (line.element().getWait()) + " seconds");
			}
			System.out.print("");
			wait++;
		}
